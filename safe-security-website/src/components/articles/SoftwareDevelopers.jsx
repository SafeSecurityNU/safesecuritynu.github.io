...
export default function SoftwareDevelopers() {
    return (
        <>
            ...
            <Image src="" alt="diverse infrastructure diagram" />
            ...
            <Image src="" alt="shell injection attack example" />
            ...
            <Image src="" alt="simple program shell injection" />
