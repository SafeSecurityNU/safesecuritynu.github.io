    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/4QTzsOI.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }} />
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/plVELZ8.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }} />
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/OKW0fI4.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/8LXcGnB.jpg" alt="Email from someone pretending to be an Ebay Representative. The contents say that the recipient's account has been suspended and that they need to resolve the issue through the given link," loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/W0TQoNS.jpg" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/P1Ty1K6.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/ax1G4Gj.png" alt="Picture showing how to block a scammer" loading="lazy" style={{ width: '400px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/5X1cVcA.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/IOznQ34.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/sPcjOZl.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/D6lRUA3.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/UAUptst.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/vNZXh0f.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/Bgqf8yy.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/oB9hVGw.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/9Hm9cY1.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/uwVwrXD.png" alt="Email containing sensitive information. There is a red highlight over" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/0B3fAsx.png" alt="Security Mode from Gmail. Image shows the options, such as an expiration date for the email, and whether it requires a passcode to open." loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/VgiHzpR.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/oYu4OZB.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/bAfe450.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/owMpt9r.jpg" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/faEDNKs.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/OTQ0sAE.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/62c3bny.png" alt="Email from a scammer offering a job as a university student." loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src="https://i.imgur.com/gR0Kz3S.png" alt="" loading="lazy" style={{ width: '650px', height: 'auto' }}/>
            </div>
            <br></br>
        </>
    )
