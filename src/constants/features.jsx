...
export const featuresList = [
  ...
  {
    icon: <LandPlot />,
    text: "Compete in Cyber Policy and Capture The Flag Games",
    description:
      "Challenge your understanding of security by competing in policy and Capture The Flag mini games.",
  },
];