...
export default function MobileUsage() {
    return (
        <>
<Body>Have a phone? Anyone with a phone - iPhone or Android - can be at risk for attacks.</Body>
<Body>A phone is basically a mini computer that you carry with you everywhere; it contains a lot of important information about you. Mobile banking access, emails, photos, Apple or Google pay, your contact information, friends and family contact information, social media accounts, all other apps (Grubhub),work accounts, etc. are all examples of information that you wouldn’t want anyone else to know! Access to this kind of information makes your money, identity, behavior patterns, friends/family information accessible to criminals.</Body>
<Body>But this doesn’t mean you should just stop using your phone! You can secure your phone and information in a few simple steps!</Body>
<TableOfContents>
<ContentLevelOne text ="How to Use This Guide"/>
<ContentLevelOne text ="Mobile App Security and Privacy"/>
<ContentLevelTwo text ="Heard of The App Store? Use Tt."/>
<ContentLevelTwo text ="Do I Bother Reading Privacy Policies? Care About These 3 Things."/>
<ContentLevelThree text ="How Do I Know What Data An App Collects From Me?"/>
<ContentLevelThree text ="Let’s Talk About Dangerous Apps"/>
<ContentLevelTwo text ="Got Any Apps? Follow These 5 Tips To Secure Them."/>
<ContentLevelThree text ="Can I Allow Chrome To Access All of My Photos, Camera, Microphone, Etc?"/>
<ContentLevelThree text ="Can I Allow Google To Always Access My Location?"/>
<ContentLevelThree text ="I Just Downloaded An App. Should I Sign In With My Google or Other Existing Account?"/>
<ContentLevelThree text = "Forgot You Had An App Downloaded? Delete It."/>
<ContentLevelThree text = "Are You Running an Older Version of TikTok? Instagram? Another App? Update It."/>
<ContentLevelOne text = "Mobile Connection Tech"/>
<ContentLevelTwo text = "Do You Have Home Wifi?"/>
<ContentLevelTwo text = "How Do I Secure My Router?"/>
<ContentLevelTwo text = "How Do I Secure My Wifi?"/>
<ContentLevelTwo text = "Starbucks Wifi, Anyone?"/>
<ContentLevelThree text = "How Do I Prevent Public Wifi Attacks?"/>
<ContentLevelTwo text = "Do You Use Airpods or Any Other Wireless Device?"/>
<ContentLevelThree text = "How Do I Prevent Bluetooth Attacks?"/>
<ContentLevelTwo text = "Do You Use Google Maps or Apple Maps? Uber/Lyft? Grubhub? Or Any Other Location-Based App?"/>
<ContentLevelThree text ="How Do I Prevent Third Parties From Knowing Where I Am?"/>
<ContentLevelOne text = "Securing Your Phone"/>
<ContentLevelTwo text = "Should I Use A Traditional Password or Biometric?"/>
<ContentLevelThree text = "How Do I Find My Phone If It Gets Lost or Stolen?"/>
<ContentLevelOne text = "Resources"/>
</TableOfContents> 
<Section>How to Use This Guide</Section>
<Body>We recommend all readers read the bolded advice from each section - being as secure as possible certainly doesn’t hurt!</Body>
<Body>However, we also know that all advice does not apply to everyone so we’ve split this guide into sections. Make sure to read the sections that apply to you and feel free to read anything else! Our goal is to help you.</Body>
<Section>Mobile App Security and Privacy</Section>
<Body>Do you have Angry Birds installed on your phone? TikTok? Candy Crush?</Body>
<Body>There are so many apps out there that we install to keep ourselves entertained, stay connected with the world, and manage our lives. Many of them are great and safe to use, but some might not be as safe.</Body>
<Body>Let’s explore how to keep ourselves safe before and after downloading an app.</Body>
<Section>Heard of The App Store? Use It.</Section>
<Body>The official app store–for Apple iPhones it’s App Store and Android phones it’s Google Play–is automatically installed on your phone when you buy it. Why? It’s a trustworthy source and here’s why:</Body>
<BulletItem>Apps submitted to the app store are <strong>reviewed and approved by a professional</strong>. This means someone physically downloaded the app to test it, making sure there weren’t any bugs or errors. More importantly, they checked that the app had no malicious behavior. These professionals also check that apps follow app store guidelines.</BulletItem>   
...
<Body>There are 4 main sections:</Body>
    ...
    <LabeledItem label="3">Data linked to you</LabeledItem>
    <LabeledItem label="4">Data not linked to you</LabeledItem>
...
<LabeledItem label="1"><strong>NOT</strong> updated within the last year</LabeledItem>
<LabeledItem label="2">Does <strong>NOT</strong> allow you to delete accounts (check using ctrl+F “delete” or “erase”)</LabeledItem>
<LabeledItem label="3"><strong>NO</strong> contact information (check using ctrl+F “contact”)</LabeledItem>
...
<LabeledItem label="1">For Apple users: <Hyperlink href="https://developer.apple.com/app-store/app-privacy-details/#user-tracking" text="check out here"/></LabeledItem>
<LabeledItem label="2">For Android users: <Hyperlink href="https://support.google.com/googleplay/android-developer/answer/10787469?hl=en#zippy=%2Cdata-types.” text=”check out here"/></LabeledItem>
...
<SubSubSection>Never Download Apps From a Website.</SubSubSection>
<Body>Why? The main reason is to avoid bad apps. When we say a bad app, we are talking about what is professionally dubbed a <strong>Potentially Harmful App (PHA).</strong> A PHA is an app that can put you, your data, or your phone at risk. In other words, there are malicious intentions behind this app which can include collecting your private information without consent, charging you money in intentionally deceiving ways, or even taking control of your phone.</Body>
<Body>A Potentially Harmful App is a harmful app, so what’s with the “potentially”? Simply put, it just depends on your phone. A PHA can be potentially harmful for one phone but not another because malicious apps function differently depending on a variety of variables. For example, a shiny iPhone 14 Pro might not be affected by EvilAppHehe which uses a deprecated service to perform malicious behavior, but an iPhone 7 which is running an ancient, outdated version might be at risk.</Body>
<Body><strong>This is why you should always update your phone’s software.</strong></Body>
<SubSection>How Can I Steer Clear of Dangerous Apps?</SubSection>
<Body>So how can you avoid a PHA? The simple answer is to <strong>only download apps from the app store.</strong></Body>
<Body>Before you click download on the app store, make sure you read the reviews as well.</Body>
<SubSubSection>Spare 5 Seconds And Read The Top Three Reviews.</SubSubSection>
<Body>While the app store is a trustworthy source, this does not guarantee that apps on there are 100% safe and risk free. It’s possible that the reviewer missed something as small as a malicious line of code, so always check what other people say about the app. If the app is “sketchy” or glitchy, you’ll immediately know from the comments.</Body>
<Section>Got Any Apps? Follow These 5 Tips To Secure Them.</Section>
<Body>Venmo? Uber? Chrome? TikTok? Facebook? Instagram? Grubhub? Candy Crush? Subway Surfers? Surely you’ve got at least one app installed on your phone.</Body>
<Body>We’re going to step through 5 general tips to secure already installed apps:</Body>
	<LabeledItem label="1">Review app permissions</LabeledItem>
    <LabeledItem label="2">Limit location permissions</LabeledItem>
    <LabeledItem label="3">Limit integrating external accounts</LabeledItem>
    <LabeledItem label="4">Delete unused apps</LabeledItem>
    <LabeledItem label="5">Update app software</LabeledItem>
<SubSection>Can I allow Chrome to access all of my photos, camera, microphone, etc?</SubSection>
...
<Body>And just go down the list! Yes, you do need to manually go through each of your apps. While it might take a good 20 minutes to review, the payoff is worth it.</Body>
<Body>Pay special attention to <strong>contact list, camera, storage, location, and microphone permissions.</strong> These are particularly private permissions that can reveal a lot about one’s identity.</Body>
<SubSection>Can I allow Google to always access my location?</SubSection>
...
<BulletItem>Go to Settings → Privacy and Security → Location Services</BulletItem>
...
<SubSection>Are you running an older version of TikTok? Instagram? Another app? Update it.</SubSection>
<SubSubSection>Keep all apps up to date.</SubSubSection>
...
<Body>Wifi is a wireless technology that is used to connect computers, tablets, smartphones, and other devices to the internet. The internet is the collection of all websites that you probably regularly visit, like google.com, youtube.com, or amazon.com. In fact, you might even be reading this manifesto on a website!</Body>
<Body>To connect to wifi you need to get a piece of equipment called a router. Therefore, to secure your home wifi,  you need to secure the home wifi and router.</Body>
<SubSection>How do I secure my router?</SubSection>
...
<SubSubSection>Make sure your router password is different from your wifi password</SubSubSection>
<Body>Your router and wifi passwords should be different because if a hacker can guess one, you don’t want them to get access to both your router and wifi. If they get access to your router, they could change your router settings to have the lowest level of security and make it easily hackable. Another attack could be to change your router settings to redirect you to malicious websites. If they have access to your wifi, they could view everything you do on the internet and get your login credentials or use your wifi to perform other illegal activities.</Body>
<SubSection>How do I secure my wifi?</SubSection>
...
<Body>That’s it! Now your information is much more secure on all websites you visit!</Body>
<Section>Starbucks Wifi, Anyone?</Section>
<Body><strong>Do you use public wifi?</strong> It’s so convenient and free! Have you ever stayed to work in a cafe after getting some coffee? Or did some last minute work before your flight in the airport using the convenient airport wifi?</Body>
<Body>Unfortunately although using public wifi might seem convenient, those scenarios might have put your personal information in danger.</Body>
<Body>In 2017, a guy named Noah Dinkin went to a Starbucks in Buenos Aires and connected to the Starbucks wifi. His computer alerted him that the connection was delayed, so he (a guy working in tech) did some investigating and found that the computers connected to the wifi were being used to mine for cryptocurrency in the first 10 seconds that they were connected. Mining for crypto means solving complicated mathematical equations to verify crypto-currency transactions and for computers who are first to solve a challenge, they get rewarded with newly minted "coins”. It takes a lot of computing power and there are actually types of attacks where you use up all of a devices’ computing power so that you can’t do anything anymore.</Body>
<Body>Of course, Starbucks quickly fixed the issue and removed a line of code that made the computers do this whenever they first connected. To this day, no one knows the name of the hacker that added this code.</Body>
<Body>In the end, the result of this Buenos Aires Starbucks story wasn’t terribly malicious but the idea is that someone was able to change the script so that everyone’s computer was forced to do something they didn’t want to do - think about what else hackers could do!</Body>
<SubSection>How do I prevent public wifi attacks?</SubSection>
<Body>To prevent public wifi attacks, follow these steps:</Body>
...
<SubSubSection>EVEN better yet, don’t use public wifi! Use mobile data instead.</SubSubSection>
<Body>Bottom line: public wifi is not as secure as personal wifi, so to prevent hackers from getting access to your information over public wifi, don’t use public wifi! Using mobile data is much safer.</Body>
<Body>Mobile data is another way you can connect to the internet that is offered by your mobile provider (i.e. Verizon, AT&T). Mobile data is encrypted, like the WPA2 router setting, so your information will be unreadable to hackers that intercept the data you send to websites.</Body>
...
<Body>Bluetooth is another form of mobile connection technology that can be manipulated for malicious uses.</Body>
<Body>In Bournemouth, a town in the UK, a student went to go pick up his prescription and then received an automated message that looked just like someone was sharing someone’s contact info with him. Then a few months later, he went back to get another prescription, parked in the same spot, and received the same message. Noticing that something was off he brought a friend and then both he and his friend received the messages. This person received the same strange message on 3 separate occasions, everytime he went to the same area. They notified the police and the police discovered that this was a bluetooth attack and issued an order to turn off bluetooth when not in use in the area.</Body>
<SubSection>How do I prevent bluetooth attacks?</SubSection>
<Body>Here’s how to prevent these kind of attacks:</Body>
<SubSubSection>Turn bluetooth off when not in use</SubSubSection>
...
<Body>Unfortunately, sometimes it’s not great for other parties to know your location.</Body>
<Body>Having access to your location can inform other parties about your daily/weekly habits, which can be dangerous; it increases the <strong>predictability of your current or future location.</strong> For example, if apps find out that you’ve been going to Whole Foods every Saturday from 2-3pm, then someone might try to find you there during your weekly visit or know when you’re not at home.</Body>
<Body>With just a few locations, other parties will also be able to build a <strong>data profile</strong> about you. Go to Whole Foods and yoga studios? Chances are you might be a health fanatic. Targeted ads might start appearing such as Lululemon or Peloton. Or worse, hackers could use this data profile to end up stealing your identity.</Body>
<SubSection>How do I prevent third parties from knowing where I am?</SubSection>
<SubSubSection>Don’t allow apps location permissions unless the app can’t function without it (i.e. google maps)</SubSubSection>
<Body>Since location services can provide vulnerable data, just don’t let apps see your location unless you need to! <strong>A rule of thumb is to just allow your maps app, ride sharing, food delivery, and weather app to know where you are ONLY WHILE using the app.</strong> There is no benefit for you to tell apps where you are when you’re not using them. Reference the app’s advice sections above to learn how to change app permissions.</Body>
<SubSubSection>Turn off location services when not in use</SubSubSection>
...
<Body>In the event that someone does end up stealing your phone, you need preparative measures to ensure that you can try to get your phone back and that they can’t get any valuable information out of it.</Body>
<Section>Should I use a traditional password or biometric to secure my phone?</Section>
<Body>The traditional password is a series of alphabetical/numerical characters used as a lock to a device or account i.e. password123. Biometrics are another form of password: they are body characteristics that are used for passwords. On mobile phones, that can include face recognition or fingerprints.</Body>
<Body>Now you might be wondering which is more secure. Surely a thief likely won’t be able to simulate my face or fingerprint, right?</Body>
<Body>First and most obviously, <strong>have a password to your phone.</strong> If there’s no password, then a thief will have access to absolutely everything. Any kind of password - an alphabetical/numerical or biometric - is the bare minimum. Now that your phone has a password, you might be wondering which type of password is more secure.</Body>
<SubSubSection>It doesn’t matter if you use a biometric or traditional password because traditional typed passwords are ALWAYS the fallback. Your typed password in the end has to be strong.</SubSubSection>
<Body>While it might seem more difficult to simulate someone’s face, in the end, after several incorrect biometric attempts, your typed password will be requested. Therefore regardless of the type of password you use, your typed password needs to be strong otherwise a hacker will be able to unlock your phone. A good rule of thumb for creating strong passwords is that the <strong>longer, more complex, and no self identifying info</strong> the better. Complex means special characters (i.e. @#$%^&*), numbers, and capital letters. You should not use any self identifying information in your password because they are easily guessable. That includes birthdays, names, places, hobbies, etc.</Body>
<Section>How do I find my phone if it gets lost or stolen?</Section>
<Body>Remote tracking allows you to see the real-time location of your phone from another device. But to use remote tracking, you need to turn it on <strong>BEFORE</strong> you lose your phone. Just to be on the safe side, turn it on while you still have your phone!</Body>
...
<References>
    ...
    <ReferenceItem label="4">https://aisel.aisnet.org/confirm2016/20/</ReferenceItem>
    <ReferenceItem label="5">https://developer.apple.com/app-store/review/</ReferenceItem>
    <ReferenceItem label="6">https://developer.apple.com/app-store/review/guidelines/#code-of-conduct</ReferenceItem>
    <ReferenceItem label="7">https://www.bournemouthecho.co.uk/news/19130289.bournemouth-residents-advised-look-bluetooth-malware/</ReferenceItem>
    <ReferenceItem label="8">https://www.experian.com/blogs/ask-experian/biometrics-vs-passwords-which-is-safer/#:~:text=Biometrics and passwords are both designed to authenticate your identity,retina patterns to identify you</ReferenceItem>
    <ReferenceItem label="9">https://www.trustedreviews.com/explainer/what-is-samsung-knox-security-2-4208348</ReferenceItem>
    <ReferenceItem label="10">https://tech.co/password-managers/how-many-passwords-average-person</ReferenceItem>
    <ReferenceItem label="11">https://www.cashify.in/do-you-need-antivirus-software-for-your-android-smartphone</ReferenceItem>
    <ReferenceItem label="12">https://www.avast.com/c-can-phones-get-viruses</ReferenceItem>
    <ReferenceItem label="13">https://consumer.ftc.gov/articles/how-secure-your-home-wi-fi-network</ReferenceItem>
    <ReferenceItem label="14">https://consumer.ftc.gov/articles/how-safely-use-public-wi-fi-networks</ReferenceItem>
    <ReferenceItem label="15">https://wiseguys.co.uk/starbucks-security-breach-and-the-risks-of-public-wifi/</ReferenceItem>
    <ReferenceItem label="16">https://medium.com/gigareef/why-browsing-on-starbucks-wi-fi-is-dangerous-and-how-you-can-best-play-it-safe-959e7716f412</ReferenceItem>
    <ReferenceItem label="17">https://www.fcc.gov/consumers/guides/how-protect-yourself-online</ReferenceItem>
    <ReferenceItem label="18">https://www.youtube.com/watch?v=_WHynHcXm7c&t=149s&ab_channel=Google</ReferenceItem>
    <ReferenceItem label="19">https://www.bbc.com/news/technology-42338754</ReferenceItem>
    <ReferenceItem label="20">https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-121r2-upd1.pdf</ReferenceItem>
    <ReferenceItem label="21">https://www.networkworld.com/article/2360206/how-do-mobile-location-services-threaten-users.html</ReferenceItem>
